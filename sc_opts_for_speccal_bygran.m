function opts = sc_opts_for_speccal_bygran(band,run_name_prefix,kmaxmin,day);
%---------------------------------------------------------------------------------
...
% datadir = ['/asl/rtp/rtp_cris_NOAA_sdr_hires/allfov/2019/' day
%           ];
datadir = ['/asl/rtp/cris/npp_restart_hires/allfov/2022/' day]
datadir = ['/asl/rtp/cris/snpp_072023restart/allfov/2023/' day]
datadir = ['/asl/rtp/cris/j01_noaa/allfov/2023/' day]]
%datadir = ['testrtp/allfov/2022/' day]
% Test day is: 211
...
% Band2 mid/upper trop water
   ...
   opts.min_sc = 3;
   opts.max_dbt_surf = 5;
   opts.szminmax = [0 180];  % day and night
%   opts.szminmax = [90 180];  % night
%   opts.szminmax = [0 180];
